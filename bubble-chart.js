  ...
  $.extend(d3.svg.BubbleChart.prototype, {
    ...
    registerClickEvent: function (node) {
      ...
      node.style("cursor", "pointer").on("click", function (d) {
        ...
        /***** MANTHAN SEE HERE ***/
        //This is the line which will give you the variable that has been clicked. Save this in a global variable.
        console.log(d['item']['text']);
        //alert(d['item']['text']);
		parent.document.getElementById("disease1").innerHTML = d['item']['text'];
        myFunction99();
